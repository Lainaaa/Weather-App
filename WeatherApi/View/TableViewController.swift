...
//  WeatherApi
//
//  Created by Dmitrij Meidus on 18.10.22.
//
...
class TableViewController: UITableViewController {
    ...
    var nameCitiesArray = ["Москва","Калининград","Санкт-Петербург","Казань","Владивосток","Владикавказ","Пятигорск","Уфа","Пенза","Краснодар"]
